...
Welcome to the **GitHub Actions Training** workshop! This guide contains **seven hands-on labs** that will walk you through creating, running, and understanding GitHub Actions workflows — from the simplest "Hello World" to advanced topics like self-hosted runners and pipeline migration.
